output_linux_debug="./_build/linux/tokensvc_debug"
output_linux_production="./_build/linux/tokensvc_production"
output_mac="./_build/mac/tokensvc"
output_win="./_build/win/tokensvc.exe"
output="./_build/"
